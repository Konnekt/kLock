...
namespace kLock
{
	...
	void EnableActs()
	{
		...
		UIActionSetStatus(sUIAction(kLock::Config::Group, kLock::Config::SynchronizeWithExtendedAway), 0, ACTS_DISABLED);
	...
	void DisableActs()
	{
		...
		UIActionSetStatus(sUIAction(kLock::Config::Group, kLock::Config::SynchronizeWithExtendedAway), -1, ACTS_DISABLED);
